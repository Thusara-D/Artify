...
import com.artselling.backend.payload.request.LoginRequest;
import com.artselling.backend.payload.request.SignupRequest;
import com.artselling.backend.payload.response.JwtResponse;
...
import com.artselling.backend.security.jwt.JwtUtils;
...
public class AuthController {
    ...
    @Autowired
    com.artselling.backend.service.ActivityLogService activityLogService;
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        activityLogService.log("LOGIN", userDetails.getUsername(), "User logged into the system");
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        activityLogService.log("REGISTRATION", user.getUsername(), "New user registered with roles: " + strRoles);
